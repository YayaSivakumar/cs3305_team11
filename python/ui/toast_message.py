...
class ToastMessage(QWidget):
    def __init__(self, message, status, timeout=True, opacity=1.0, font_size=12, parent=None):
        ...
        self.selected_style_class = style_classes.get(status, InfoStyle(opacity=opacity, font_size=font_size))
        ...
        self.label = self.create_label(message)
    ...
    def create_close_button(self):
        ...
        close_button.setStyleSheet("color: #000000;")
        return close_button
